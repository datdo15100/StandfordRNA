...
- Ba nguồn Kaggle được dùng đúng vai trò: documentation chính thức cho protocol,
  notebook TBM-only cho mốc 0.593 và notebook hybrid công khai cho mốc 0.576. Điểm
  0.578 của đội thắng cuộc được ghi tách biệt với hai notebook.
...
theo metadata này. Bốn entry không dùng DOI là sách bootstrap, trang cuộc thi chính thức
và hai notebook Kaggle công khai.
...
Citation audit tự động xác nhận cả 29 key được dùng trong hai bản luận văn đều có entry
